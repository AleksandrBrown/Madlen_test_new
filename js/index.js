...
function mobNavigationActive () {
    ...
    mob_head_logo.classList.add('active_mob-nav_logo')
    mobCartBlock.classList.add('active_mob-nav_cart-block')
...
function mobNavigationClose () {
    ...
    mob_head_logo.classList.remove('active_mob-nav_logo')
    mobCartBlock.classList.remove('active_mob-nav_cart-block')
